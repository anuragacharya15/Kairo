...
const labelVariants = cva(
  "text-xs font-semibold leading-none tracking-wide text-gray-500 uppercase peer-disabled:cursor-not-allowed peer-disabled:opacity-40 transition-colors duration-150",
);
