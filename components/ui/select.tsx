...
const SelectTrigger = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Trigger>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger>>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "rounded-xl border border-purple-100 bg-white px-4 py-2",
      "text-sm font-medium text-gray-700 shadow-sm shadow-purple-50",
      "data-[placeholder]:text-gray-300",
      "transition-all duration-200",
      "hover:border-purple-200 hover:shadow-purple-100/60",
      "focus:outline-none focus:border-purple-300 focus:ring-2 focus:ring-purple-100 focus:ring-offset-0",
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-purple-300 shrink-0 transition-transform duration-200" />
...
const SelectScrollUpButton = React.forwardRef<React.ElementRef<typeof SelectPrimitive.ScrollUpButton>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.ScrollUpButton>>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={cn(
      "flex cursor-default items-center justify-center py-1.5 text-purple-300 hover:text-purple-500 transition-colors",
      className
    )}
    {...props}
  >
...
const SelectItem = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Item>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item>>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-xl py-2 pl-3 pr-9 text-sm font-medium text-gray-700",
  ...
  >
    <span className="absolute right-3 flex h-4 w-4 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-3.5 w-3.5 text-purple-500 stroke-[3]" />
      </SelectPrimitive.ItemIndicator>
    </span>
